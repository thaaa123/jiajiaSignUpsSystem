  ...
  devServer: {
    before(app) {
      ...
      app.get('/api/getTeacher', function (req, res) {
        const url = 'http://jiajia.xuyue.ren/Api/WeChat/GetTeacher?sheTuanId=' + req.query.assId
        axios.get(url, {
          headers: {
            referer: 'http://jiajia.xuyue.ren/',
            host: 'jiajia.xuyue.ren'
      ...
      app.get('/api/getAlbum', function (req, res) {
        const url = 'http://jiajia.xuyue.ren/Api/WeChat/GetAlbum?sheTuanId=' + req.query.assId
        axios.get(url, {
          headers: {
            referer: 'http://jiajia.xuyue.ren/',
            host: 'jiajia.xuyue.ren'
